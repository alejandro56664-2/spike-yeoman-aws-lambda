...
module.exports = class extends FnGenerator {
    ...
    const prompts = [
      {
        ...
        name: "functionName",
        message:
          "¿Cuál es el nombre de la función a la que desea agregar el adaptador backend?",
  ...
  initializing() {
    ...
    this.composeWith(require.resolve("../repository-dynamodb"), {
      invokedFromBackendManager: true,
    });
  }
};
